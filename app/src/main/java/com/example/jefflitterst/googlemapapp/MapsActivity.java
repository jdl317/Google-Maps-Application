...
public class MapsActivity extends AppCompatActivity implements OnMyLocationButtonClickListener, ActivityCompat.OnRequestPermissionsResultCallback, OnMapReadyCallback {
    ...
    public boolean onMyLocationButtonClick() {
        ...
        try {
            ...
            LatLng zoellner = new LatLng(40.607267, -75.374077);
            //mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng));
            mMap.moveCamera(CameraUpdateFactory.newLatLng(taylorGym));
            mMap.animateCamera(CameraUpdateFactory.zoomTo(10));
            //mMap.addMarker(new MarkerOptions().position(new LatLng(latitude, longitude)).title("You are here!").snippet("Consider yourself located"));
            mMap.addMarker(new MarkerOptions().position(taylorGym).title("Welcome to Taylor Gym!").snippet("Consider yourself located"));
            mMap.addMarker(new MarkerOptions().position(zoellner).title("Welcome to Zoellner!").snippet("Consider yourself located"));
            LatLng myCoordinates = taylorGym;//new LatLng(40.607479, -75.374098);
